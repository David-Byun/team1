  ...
  <script>
    ...
    $(function () {
      ...
      $('#role_add').click(function(e){
        ...
        // 새로운 select 요소 생성
        let newSelect = $('<select class="form-control select2 select2-hidden-accessible" style="width: 50%; margin-right:0.5%;" tabindex="-1" aria-hidden="true">');
                      ...
                      <form action="/post" method="post" enctype="multipart/form-data">
                        <div id="role_apply">
                          <div id="role_1"style="display:flex; margin-bottom: 0.5%;">
                            <select class="form-control select2 select2-hidden-accessible" style="width: 50%; margin-right:0.5%;" tabindex="-1" aria-hidden="true">
                              <option value="">와우</option>
                            </select>
