          ...
          <div class="col-lg-9 col-xxl-10">
            <div class="card mb-3">
              ...
              <div class="card-body bg-light">
                <p class="mb-0">Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages.</p><a class="btn btn-link pl-0 btn-sm d-flex align-items-center" href="https://getbootstrap.com/docs/4.4/components/alerts/" target="_blank"> Alerts on Bootstrap<span class="uil uil-angle-right ml-n2 fs-2 header-icon"></span></a>
              </div>
            </div>
            <div class="card mb-3">
              <div class="card-header">
