...
<div class="content col-xxl-9" style="margin: auto; padding: 5% 0% 0% 0%">
    <div class="row mx-n2" style="padding: 20px; font-size: x-large; font-weight: bold; color: #0e1628">
        HOT 프로젝트
    </div>
    ...
    <div id="review" class="row mx-n2">
        <div class="px-2 col-sm-6 col-lg-4 col-xxl-4 review-1">
            <div class="card card-blog"><img class="card-img img-fluid" src="/assets/img/group/page1.jpg" alt="" />
                <div class="card-img-overlay d-flex flex-column justify-content-between">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div></div><a class="badge badge-pill stretched-link ml-2 badge-info" href="#">백엔드 개발자</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="px-2 col-sm-6 col-lg-4 col-xxl-4 review-1">
            <div class="card card-blog"><img class="card-img img-fluid" src="/assets/img/group/page2.jpg" alt="" />
                <div class="card-img-overlay d-flex flex-column justify-content-between">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div></div><a class="badge badge-pill stretched-link ml-2 badge-primary" href="#">기획자</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="px-2 col-sm-6 col-lg-4 col-xxl-4 review-1">
            <div class="card card-blog"><img class="card-img img-fluid" src="/assets/img/group/page4.jpg" alt="" />
                <div class="card-img-overlay d-flex flex-column justify-content-between">
        ...
        <div class="px-2 col-sm-6 col-lg-4 col-xxl-4 review-1">
            <div class="card card-blog"><img class="card-img img-fluid" src="/assets/img/group/page3.jpg" alt="" />
                <div class="card-img-overlay d-flex flex-column justify-content-between">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div><span class="uil fs-3 text-300 align-middle uil-book-alt"></span><span class="text-white fs--1 mb-0 d-inline-block">Coworking Business Model</span></div><a class="badge badge-pill stretched-link ml-2 badge-primary" href="#">디자이너</a>
                    </div>
                </div>
            </div>
        </div>
